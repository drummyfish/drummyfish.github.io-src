...
def set_common_variables(module_ref):
  ...
  #module_ref.PLUGINS = ["jinja2content","i18n_subsites","pelican_githubprojects","commits"]
  module_ref.PLUGINS = ["jinja2content","i18n_subsites","pelican_githubprojects","commits"]
  ...
  module_ref.STATIC_PATHS = ["images","extra","../README.md"]
  module_ref.ARTICLE_EXCLUDES = ["extra"]
